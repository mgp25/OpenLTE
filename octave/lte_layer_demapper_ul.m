...
%
% Function:    lte_layer_demapper_ul
% Description: De-maps one or several uplink layers into complex-valued
%              modulation symbols
% Inputs:      x     - Mapped complex valued modulation symbols
...
%
function [d] = lte_layer_demapper_ul(x, N_ant, N_cw)
